...
import * as answers from './src/functions.js';
...
describe('Addition function', function(){
    ...
    it('should tell user to use numbers', function() {
        assert.equal(answers.addition('a', 4), 'Use only numbers');
    });
});

describe('Relevant game objects', function(){
    it('should return correct object format', function(){
        assert(answers.relevantGameObjects(gamesList), 
        [{
            color: 'white',
            result: 'win',
            myRating: 1368,
